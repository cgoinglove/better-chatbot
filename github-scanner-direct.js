// Direct GitHub Repository Scanner
// This script can be run directly to list GitHub repositories
// Run with: node github-scanner-direct.js
...
try {
  ...
  console.log("\nRepository data as JSON:");
  console.log(JSON.stringify(repositories, null, 2));
} catch (error) {
  console.error(`Error listing GitHub repositories: ${error.message || String(error)}`);
}
