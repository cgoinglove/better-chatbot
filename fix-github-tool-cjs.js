// Direct fix for the GitHub repository listing tool (CommonJS version)
// This script directly modifies the custom MCP server file to fix the "require is not defined" error
// Run with: node fix-github-tool-cjs.js
...
const testScriptPath = path.join(__dirname, 'test-github-list-cjs.js');
const testScriptContent = `// Simple script to test the GitHub repository listing functionality
// Run with: node test-github-list-cjs.js

const { spawn } = require('child_process');
const path = require('path');

// Path to the custom MCP server
const serverPath = path.join(__dirname, 'custom-mcp-server', 'index.ts');
...
console.log('You can run it with: node test-github-list-cjs.js');
