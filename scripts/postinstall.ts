...
async function main() {
  if (IS_VERCEL_ENV) {
    ...
    console.log("Running on Vercel, skipping database migration during build.");
    console.log("Database migration will be handled at runtime when the application starts.");
